...
![Version](https://img.shields.io/badge/version-3.0-blue) ![Role](https://img.shields.io/badge/role-Curador%20%7C%20Sparring%20Partner-BC955C) ![System](https://img.shields.io/badge/system-Obsidian%20Zettelkasten-235B4E)
...
* **Modos Operativos:**
    ...
    * 🔗 **Modo Análisis de Cluster:** Síntesis de múltiples notas para la creación de artículos, clases o ensayos.
* **Formatos de Salida:** Plantillas estrictas de Markdown y YAML Frontmatter compatibles con Obsidian.
...
```text
.
├── borges_config.json       # 🧠 Código fuente del agente (System Prompt completo)
